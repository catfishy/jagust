...
# LME MODELS: Normals 
fm_uwef_cs = lmer(UW_EF_ ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_ef)
fm_uwmem_cs = lmer(UW_MEM_ ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_mem)
fm_avlt_cs = lmer(AVLT. ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_avlt)
fm_adas_cs = lmer(ADAScog. ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_adas)
fm_wmh_cs = lmer(WMH_percentOfICV. ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_wmh)
fm_av45_cs = lmer(AV45 ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1|RID), df_av45)
fm_hcicv_cs = lmer(100*FSX_HC.ICV_ ~ diag_prior + diag_prior:YrsPostBL + CORTICAL_SUMMARY_POSITIVE + CORTICAL_SUMMARY_POSITIVE:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_hcicv)

fm_uwef = lmer(UW_EF_ ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_ef)
fm_uwmem = lmer(UW_MEM_ ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_mem)
fm_avlt = lmer(AVLT. ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_avlt)
fm_adas = lmer(ADAScog. ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_adas)
fm_wmh = lmer(WMH_percentOfICV. ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_wmh)
fm_av45 = lmer(AV45 ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1|RID), df_av45)
fm_hcicv = lmer(100*FSX_HC.ICV_ ~ diag_prior + diag_prior:YrsPostBL + X1 + X1:YrsPostBL + X4 + X4:YrsPostBL + X22 + X22:YrsPostBL + X25 + X25:YrsPostBL + APOE4_BIN + APOE4_BIN:YrsPostBL + Age.AV45 + Gender + Edu..Yrs. + YrsPostBL + (1 + YrsPostBL |RID), df_hcicv)
...
# VISUALIZE MODELS
sjp.int(fm_avlt,type='cond',swapPredictors=TRUE, showCI=TRUE)
