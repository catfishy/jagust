...
if __name__ == "__main__":
    ...
    other=[0,4,8,10,17,18,26,28,30,43,47,49,53,54,58,60,62,80,1000,1001,1005,1006,1007,1009,1013,1016,1017,1021,1022,1024,1033,1034,1035,2000,2001,2005,2006,2007,2009,2013,2016,2017,2021,2022,2024,2033,2034,2035]
    ...
    WM=[2,7,16,41,46,77,251,252,253,254,255,85,2004,1004]
    other=[0,4,8,10,17,18,26,28,30,43,47,49,53,54,58,60,62,80,85,1000,1001,1005,1006,1007,1009,1013,1016,1017,1021,1022,1024,1033,1034,1035,2000,2001,2005,2006,2007,2009,2013,2016,2017,2021,2022,2024,2033,2034,2035]
    ...
    other=[0,4,18,26,28,30,43,54,58,60,62,80,1000,1001,1007,1009,1017,1033,1034,1035,2000,2001,2007,2009,2017,2033,2034,2035]
    all_groups=[frontal,parietal,temporal,cingulate,basal_ganglia,occipital,precentral_postcentral,thalamus,hemiWM,brainstem,non_hemiWM,cerebGM,hippocampus,other]
    names = ['frontal','parietal','temporal','cingulate','basal_ganglia','occipital','precentral_postcentral','thalamus','hemiWM','brainstem','non_hemiWM','cerebGM','hippocampus','other']
    print "\n\nGROUPING 3"
    printROIGrouping(names, all_groups)
