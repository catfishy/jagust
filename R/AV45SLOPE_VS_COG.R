...
#time_col_prefix = 'UW_MEM_postAV45_'
#value_col_prefix = 'UW_MEM_'
...
fm_null_tp_n = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_n)
fm_null_tp_emci = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_emci)
fm_null_tp_lmci = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_lmci)
fm_null_tp_ad = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_ad)

fm_null_pvc_n = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_n)
fm_null_pvc_emci = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_emci)
fm_null_pvc_lmci = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_lmci)
fm_null_pvc_ad = lmer(value ~ Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_ad)

fm_tp_n = lmer(value ~ AV45_TP_wcereb_Slope_2pts + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_n)
fm_pvc_n = lmer(value ~ AV45_PVC_CorticalSummary_WholeCereb_slope_2points + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_n)
fm_tp_emci = lmer(value ~ AV45_TP_wcereb_Slope_2pts + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_emci)
fm_pvc_emci = lmer(value ~ AV45_PVC_CorticalSummary_WholeCereb_slope_2points + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_emci)
fm_tp_lmci = lmer(value ~ AV45_TP_wcereb_Slope_2pts + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_lmci)
fm_pvc_lmci = lmer(value ~ AV45_PVC_CorticalSummary_WholeCereb_slope_2points + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_lmci)
fm_tp_ad = lmer(value ~ AV45_TP_wcereb_Slope_2pts + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_ad)
fm_pvc_ad = lmer(value ~ AV45_PVC_CorticalSummary_WholeCereb_slope_2points + Age.AV45 + Gender + Edu..Yrs. + APOE4_BIN*time + (1 + time | RID), df_long_ad)
