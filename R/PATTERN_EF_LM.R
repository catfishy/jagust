...
# Import data
df_av45 = read.csv('dpgmm_alpha14.36_bilateral_UW_EF__ALL_slopedata.csv')
...
fm_av45_onlycs = lm(UW_EF__slope ~ CORTICAL_SUMMARY_prior + I(CORTICAL_SUMMARY_prior^2), df_av45)
fm_av45_nopattern = lm(UW_EF__slope ~ diag_prior + CORTICAL_SUMMARY_prior*APOE4_BIN + I(CORTICAL_SUMMARY_prior^2)*APOE4_BIN + Age.AV45 + Gender + Edu..Yrs., df_av45)
fm_av45 = lm(UW_EF__slope ~ diag_prior + 
...
fm_av45_onlypatterns = lm(UW_EF__slope ~ diag_prior + 
                            X23*APOE4_BIN +
                            X18*APOE4_BIN +
                            X42*APOE4_BIN +
                            X12*APOE4_BIN +
                            ...
                            X0*APOE4_BIN +
                            Age.AV45 + Gender + Edu..Yrs., df_av45)
fm_av45_onlypca = lm(UW_EF__slope ~ diag_prior + 
                       PC1*APOE4_BIN +
                       PC2*APOE4_BIN +
                       PC3*APOE4_BIN +
                       PC4*APOE4_BIN +
                       ...
                       PC11*APOE4_BIN +
                       Age.AV45 + Gender + Edu..Yrs., df_av45)
fm_av45_pca = lm(UW_EF__slope ~ diag_prior + 
                   CORTICAL_SUMMARY_prior*APOE4_BIN +  
                   I(CORTICAL_SUMMARY_prior^2)*APOE4_BIN + 
                   PC1*APOE4_BIN +
                   PC2*APOE4_BIN +
