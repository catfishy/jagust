...
if __name__ == "__main__":
    ...
    # points = []
    # for cutoff in regions_considered:
    #     sim = getMeanAveragePrecision(sorted_avg_rankings, sorted_uptakes, cutoff)
    #     points.append((cutoff, sim))
    # plt.figure(1)
    # plt.plot([_[0] for _ in points], [_[1] for _ in points])
    # plt.show()
